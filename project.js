...
console.log("検索結果1件目");
console.log("名前: " + shopList[0].name);
console.log("アクセス: " + shopList[0].access);
console.log("住所: " + shopList[0].address);
console.log("予算: " + shopList[0].budget_memo);
console.log("キャッチコピー: " + shopList[0].catch);
console.log("ジャンル: " + shopList[0].genre.name);
console.log("営業時間: " + shopList[0].open);
console.log("最寄駅: " + shopList[0].station_name);
console.log("サブジャンル: " + shopList[0].sub_genre.name);

console.log("検索結果2件目");
console.log("名前: " + shopList[1].name);
console.log("アクセス: " + shopList[1].access);
console.log("住所: " + shopList[1].address);
console.log("予算: " + shopList[1].budget_memo);
console.log("キャッチコピー: " + shopList[1].catch);
console.log("ジャンル: " + shopList[1].genre.name);
console.log("営業時間: " + shopList[1].open);
console.log("最寄駅: " + shopList[1].station_name);
console.log("サブジャンル: " + shopList[1].sub_genre.name);
...
function displayResults() {
  ...
  // 結果表示用のHTMLコンテンツを構築します
  let htmlContent = "<ul>";
  
  // グルメ情報のタイトルを追加します
  htmlContent += "<li>グルメ情報（検索結果は2件）</li>";

  // 検索結果1件目の情報を追加します
  htmlContent += "<li>検索結果1件目</li>";
  htmlContent += "<ul>";
  htmlContent += "<li>名前: " + shopList[0].name + "</li>";
  htmlContent += "<li>アクセス: " + shopList[0].access + "</li>";
  htmlContent += "<li>住所: " + shopList[0].address + "</li>";
  htmlContent += "<li>予算: " + shopList[0].budget.name + "</li>";
  htmlContent += "<li>キャッチコピー: " + shopList[0].catch + "</li>";
  htmlContent += "<li>ジャンル: " + shopList[0].genre.name + "</li>";
  htmlContent += "<li>営業時間: " + shopList[0].open + "</li>";
  htmlContent += "<li>最寄駅: " + shopList[0].station_name + "</li>";
  htmlContent += "<li>サブジャンル: " + shopList[0].sub_genre.name + "</li>";
  htmlContent += "</ul>";

  // 検索結果2件目の情報を追加します
  htmlContent += "<li>検索結果2件目</li>";
  htmlContent += "<ul>";
  htmlContent += "<li>名前: " + shopList[1].name + "</li>";
  htmlContent += "<li>アクセス: " + shopList[1].access + "</li>";
  htmlContent += "<li>住所: " + shopList[1].address + "</li>";
  htmlContent += "<li>予算: " + shopList[1].budget.name + "</li>";
  htmlContent += "<li>キャッチコピー: " + shopList[1].catch + "</li>";
  htmlContent += "<li>ジャンル: " + shopList[1].genre.name + "</li>";
  htmlContent += "<li>営業時間: " + shopList[1].open + "</li>";
  htmlContent += "<li>最寄駅: " + shopList[1].station_name + "</li>";
  htmlContent += "<li>サブジャンル: " + shopList[1].sub_genre.name + "</li>";
  htmlContent += "</ul>";
